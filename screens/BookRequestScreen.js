...
import{BookSearch} from'react-rative-google-books'
...
addRequest =(bookName,reasonToRequest)=>{
    ...
    var books=await BookSearch.searchbook(bookName,'AIzaSyA70XDP8gdbiAqaOivk92NF0ZLG29E_sx8')
...
if(bookName.length>2){
  var books=await BookSearch.searchbook(
    bookName,"AIzaSyA70XDP8gdbiAqaOivk92NF0ZLG29E_sx8"
...
renderItem=({item,i})=>{
  let obj ={
    ...
    buyLink:item.saleInfo.buyLink,imgeLink:item.volumeInfo.imgeLink
  }
}
getBookRequest =()=>{
  // getting the requested book
